...
<html lang="en">
	...
	<!-- start: HEAD -->
	<head>
		<title>Asociatie de locatari online</title>
		<!-- start: META -->
			...
			<div id="slidingbar-area">
				<div id="slidingbar">
					...
					<div class="col-md-4 col-sm-4">
						<h2>Despre noi</h2>
						<p>
							Pe site-ul asociatie-online.ro aveti posibilitatea sa va administrati cheltuielile, pozitia contoarelor, sa verificati platile.
						</p>
					</div>
				...
				<div class="container">
					<div class="navbar-header">
						...
						<button data-target=".navbar-collapse" data-toggle="collapse" class="navbar-toggle" type="button">
							<span class="sr-only">Navigheaza</span>
						...
						<a class="navbar-brand" href="/">
							Asociatie<i class="clip-clip"></i>Online
						</a>
						<!-- end: LOGO -->
					</div>
		...
		<section class="fullwidthbanner-container">
			<div class="fullwidthabnner">
					<ul>
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							...
							data-start="2500"
							data-easing="easeOutExpo">
								Administare cheltuieli asociatie - Inregistreaza-te acum pentru 
								<br>
								a-ti usura munca
							</div>
							<a class="caption lft btn btn-green slide_btn slide_item_left" href="./login_admin"
							data-x="0"
							data-y="320"
							data-speed="400"
							data-start="3000"
							...
							data-start="1000"
							data-easing="easeOutExpo"  >
								<img src="assets/images/ipad.png" alt="Image 1">
							</div>
						</li>
						<!-- end: FIRST SLIDE -->
						<!-- start: SECOND SLIDE -->
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							...
							data-start="2500"
							data-easing="easeOutExpo">
								Trimite-ti pozitia contoarelor de acasa din fotoliu 
                                                                <br>   
								Nu reusiti sa va alinitati cu programul de lucru al asociatiei de locatari? 
                                                                <br>
                                                                Aveti acum posibilitatea sa trimite-ti situatia contoarelor de pe telefon sau calculator!
							</div>
							<a class="caption lfb btn btn-bricky slide_btn slide_item_left" href="#"
							data-x="0"
							data-y="320"
							data-speed="400"
							data-start="3000"
						...
						<li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
							...
							data-start="1500"
							data-easing="easeOutExpo">
								Foloseste site-ul nostru oriunde
							</div>
							...
							data-start="2500"
							data-easing="easeOutExpo">
								Designul simplu permite utilizarea de pe orice 
								<br>
								calculator, tableta sau telefon mobil.
							</div>
			...
			<section class="wrapper padding50">
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6">
							<h2 style="text-align: right;">Ce iti oferim?</h2>
							<hr class="fade-left">
							<p style="text-align: right;">
								Administrarea completa a asociatiei de locatari.
							</p>
							<p style="text-align: right;">
								Introducerea cheltuielilor/facturilor asociatiei.
								<br>
								Introducerea pozitiei contoarelor de apa si caldura pentru locatari.
								<br>
								Calculul cheltuieililor locatarilor pe baza formulelor de calcul adaptate la necesitatile asociatiei.
								<br>
								Servicii de consultanta si suport pentru folosirea platformei.
								<br>
							...
							<ul class="icon-list animate-group">
								<li>
									...
									<div class="icon-list-content">
										<h4>Cheltuieli/facturi</h4>
										<p>
											In sectiunea Cheltuilei puteti introduce facturile intrate pe luna de calcul, si aceste cheltuieli se vor calcula costurile fiecarui locatar pe scara sau pe bloc in functie de necesitati.
										</p>
									</div>
								</li>
								<li>
									...
									<div class="icon-list-content">
										<h4>Pozitia contoarelor</h4>
										<p>
											Pentru fiecare locatar in parte veti avea la dispozitie completarea datelor lunare, consum apa sau caldura.
										</p>
									</div>
								</li>
								<li>
									...
									<div class="icon-list-content">
										<h4>Calcul personalizat</h4>
										<p>
											Pentru fiecare asociatie putem selecta formula de calcul adecvata pentru calculul cheltuielilor locatarilor.
										</p>
									</div>
								</li>
							</ul>
					...
					<div class="col-md-4">
						<div class="contact-details">
							...
							<ul class="contact">
								<li>
									<p>
										<i class="fa fa-map-marker"></i><strong>Adresa:</strong> Oradea, Romania
									</p>
								</li>
								<li>
									<p>
			...
			<div class="footer-copyright">
				<div class="container">
					<div class="row">
						...
						<div class="col-md-7">
							<p>
								&copy; Copyright 2014 by Agile Software. All Rights Reserved.
							</p>
						</div>
						<!--<div class="col-md-4">
							<nav id="sub-menu">
